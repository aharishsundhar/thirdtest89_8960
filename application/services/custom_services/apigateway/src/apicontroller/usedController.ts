...
export class usedController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/used/:id', this.GpDelete);
this.router.get('/used/get/search', this.GpSearch);
this.router.put('/used/get/update', this.GpSearchForUpdate);
this.router.put('/used', this.GpUpdate);
this.router.get('/used', this.GpGetAllValues);
this.router.post('/used', this.GpCreate);
    }
